  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="absolute inset-0 z-10 flex items-center justify-center -mt-[20vh] sm:-mt-[15vh]"
      >
        <img
      ...
      <div
        ref={heroImageRef}
        className="absolute inset-0 z-[15] flex items-center justify-center px-6 -mt-[20vh] sm:-mt-[15vh]"
      >
      ...
      <div
        ...
        className="pointer-events-none absolute inset-0 z-[25] flex items-center justify-center -mt-[20vh] sm:-mt-[15vh]"
      >
        <img
          src="/logos/logo-got.png"
          alt=""

    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
        ...
        <a
          ...
          className="hidden shrink-0 items-center gap-2 rounded-full bg-got-accent px-5 py-2 text-sm font-semibold text-got-black transition-opacity hover:opacity-90 md:inline-flex"
        >
